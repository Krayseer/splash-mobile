...
import ru.anykeyers.client_app.data.api.APIConstants
import ru.anykeyers.client_app.data.api.OrderAPI
import ru.anykeyers.client_app.domain.auth.AuthInterceptor
import ru.anykeyers.client_app.domain.auth.AuthService
import ru.anykeyers.client_app.domain.auth.TokenProvider

private const val KEYCLOAK_BASE_URL = "http://192.168.24.188"
private const val BACKEND_BASE_URL = APIConstants.BASE_URL
